...
public class SettingsList extends List implements CommandListener {
    ...
    private final static int RECORDING = 5;
    private final static int WEB_RECORDING = 66;
    private final static int UPDATE = 3;
    private final static int DISPLAY = 4;
    private final static int DEVELOPMENT_MENU = 2;
    ...
    public void commandAction(Command command, Displayable displayable) {
        if (command == selectCommand) {
         ...
         if(getString(getSelectedIndex()).equals("Update")){
                 controller.mainmenu.updateVersion();
