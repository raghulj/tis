...
public class Controller {
   ...
   // private TrailCanvas trailCanvas;
    ...
    public String cityListURL = "http://mapunity.in/TIS_mobile_app/citydata.txt";
    /**
...
//                       }
                ...
                if (mapCity == ""){
                    controller.mapCity = "Bangalore";
                }
                 
                controller.selectedCity = (CityData) controller.cityHash.get(mapCity); 
                System.out.println("Selected city is "+controller.selectedCity);
    ...
    //      
            ...
            settings.setCityMatrix("Bangalore~~btis.in~~1~~1~~1~~1~~1~~1~~1~~1~~12.97579~~77.61142~~7||Hyderabad~~htis.in~~1~~1~~1~~0~~0~~1~~0~~0~~17.41424~~78.48541~~0||Chennai~~chennaitraffic.in~~1~~1~~1~~0~~0~~1~~0~~0~~13.0740~~80.2564~~0");
            controller.ShowCitySelectionList();
           // loadCityMatrix();
             }
  }
