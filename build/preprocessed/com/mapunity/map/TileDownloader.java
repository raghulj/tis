...
public class TileDownloader implements Runnable {
    ...
    public Image fetchTileFromDir(int x, int y, int z, boolean pushToTop)
    {
        Image theImage =null;
         System.out.println("Image called "+"/images/tile_"+x+"_"+y+"_"+z+".png");
        try{
         theImage = Image.createImage("/images/tile_"+x+"_"+y+"_"+z+".png");
         
          String targetUrl = "/images/tile_"+x+"_"+y+"_"+z+".png";
            String destDir = MapProviderManager.getCacheDir() + "/" + z
                    + "/" + x + "/";
            String destFile = y + ".png";
         Tile t = new Tile(x, y, z, targetUrl, destDir, destFile,
                    MapProviderManager.getStoreName());
         tc.saveTile(t, theImage);
         ...
         /*   if (x < 0 || y < 0) {
            ...
            synchronized (tileQueue) {
                ...
                requestLog.put(getCacheKey(x, y, z), "QUEUED");
            }*/
        
        }catch(Exception e){System.out.println("Error in startup "+e);}
        return theImage;
    }
    ...
    public Image loadingImage() {
       ...
       g.setColor(255, 255,255);
        ...
        g.drawString("Downloading..." ,TILE_SIZE/2, TILE_SIZE/2, Graphics.TOP
                | Graphics.LEFT);
        Image p = loadingImage[nullImageCounter];
